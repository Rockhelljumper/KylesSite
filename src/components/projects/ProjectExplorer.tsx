...
type ProjectExplorerProps = { projects: Project[] };
...
export default function ProjectExplorer({ projects }: ProjectExplorerProps) {
  ...
  return (
    <div className="mt-10">
      <ProjectFilters categories={projectCategories} selectedCategory={selectedCategory} onCategoryChange={setSelectedCategory} />
